...
import tech.tinhvi.cryptography.jmh_generated.AesCbcPKCS5Benchmark_jmhType;
public final class AesCbcPKCS5Benchmark_testMethod_jmhTest {
    ...
    public BenchmarkTaskResult testMethod_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            AesCbcPKCS5Benchmark_jmhType l_aescbcpkcs5benchmark0_0 = _jmh_tryInit_f_aescbcpkcs5benchmark0_0(control);
            ...
            while (control.warmupShouldWait) {
                l_aescbcpkcs5benchmark0_0.testMethod();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            testMethod_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_aescbcpkcs5benchmark0_0);
            ...
            if (control.isLastIteration()) {
                f_aescbcpkcs5benchmark0_0 = null;
            }
    ...
    public BenchmarkTaskResult testMethod_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            testMethod_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_aescbcpkcs5benchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult testMethod_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_aescbcpkcs5benchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void testMethod_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, AesCbcPKCS5Benchmark_jmhType l_aescbcpkcs5benchmark0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testMethod_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            testMethod_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_aescbcpkcs5benchmark0_0);
            control.preTearDown();
    ...
    AesCbcPKCS5Benchmark_jmhType f_aescbcpkcs5benchmark0_0;
    
    AesCbcPKCS5Benchmark_jmhType _jmh_tryInit_f_aescbcpkcs5benchmark0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        AesCbcPKCS5Benchmark_jmhType val = f_aescbcpkcs5benchmark0_0;
        if (val == null) {
            val = new AesCbcPKCS5Benchmark_jmhType();
            f_aescbcpkcs5benchmark0_0 = val;
        }
        return val;
    }
